export const quotes = [
  ...
  "Père Blaise : Non, je suis désolé, moi je peux pas faire une légende avec un vieux qui enroule sa bite autour d'un bâton. En plus je sais même pas comment ça se dit en latin.\nArthur : Quoi ? Bite ?\nPère Blaise : Non, fakir.",
