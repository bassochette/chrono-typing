export const quotes = [
  ...
  "(À Arthur, Perceval et Léodagan) Moi aussi, je ne me sens pas dans mon assiette, j'ai jamais beaucoup aimé les tunnels.",
  "(Au maître d'armes) Vous êtes un grand malade mental !",
  ...
  'On vous offre des boucs, à vous, maintenant ?',
  "Parce que j'ai le même type que les Jumelles maintenant ?",
  ...
  'Après, moi, pour le détail, je sais pas',
  ...
  "Mille excuses... Normalement, je devrais pas dire ça à un prêtre chrétien, mais, comme vous m'avez tout l'air d'être un gros baltringue euh, je me permets ? (Père Blaise : Mmmh ?...) Vous avez oublié les alliances.",
  ...
  'Peau de vache.',
  "(Au Père Blaise) Z'êtes un glandeur. Un gros... GLANDEUR !!!",
  ...
  '(À Arthur) Vous me prenez vraiment pour une conne.',
  ...
  '(À Lancelot) Eh ben, on est pas sortie du sable !',
  ...
  '(à propos du père Blaise) Il ressemble à Tatan !',
  "Le caca des pigeons c'est caca, faut pas manger.",
  "(Sur l'air de Promenons-nous dans les bois) Pas du tout, les lapins, les lapins, c'est gentil ! Le poissooon ! Le petit poissooon !",
  ...
  "(Sur l'air de Promenons-nous dans les bois) Y' vont faire des beignets !",
  ...
  "[Perceval: Si vous foutez tout en l'air, on vous envoie notre assassin, ça va pas traîner.] Ouais. Ou alors le mec qu'on dirait qu'il marche normalement mais en fait il marche alternativement à cloche-pied sur chaque pied.",
  ...
  "[Arthur : De toute façon faudra bien vous y faire parce qu'à partir de maintenant, on va s'appeler Les Chevaliers de la Table Ronde !] Encore une chance qu'on se soit pas fait construire un buffet à vaisselle, hein !",
  ...
  "(À propos d'Yvain) Il dit tellement rien qu'on dinerait avec un tabouret ce serait pareil.",
  "(À table, en famille) Calogrenant, c'est le roi des cons.",
  ...
  "(À Arthur) Moi au moins quand je parlemente, c'est pas vicelard.",
  "J'ai toujours eu du bol avec l'aléatoire, moi",
  ...
  "[À Léodagan] Écoutez, comme ça a priori, ça m'évoque rien, mais honnêtement c'est possible. Ce serait assez le genre de la maison, en tout cas ! De l'autre côté, voyez un peu l'ironie, si j'avais pas fomenté une attaque par l'ouest, vous seriez allés vous écraser contre les Romains à l'est ! Oui, alors, pourquoi ? Pourquoi trahir sans arrêt les gens avec qui je collabore ? Je dirais que c'est probablement une réponse compulsive à une crainte de m'attacher. Briser une relation plutôt que la cultiver pour ne pas se retrouver démuni face au bonheur. Oui, pour répondre à votre question : j'ai peur d'aimer !",
  ...
  "VIVIANNE : Vous voulez vraiment pas me dire qui vous êtes? MELEAGANT : Non, mon nom ne vous dira rien... Mais chez vous on m'appelle... La réponse [...] La réponse à votre pathétique désastre!",
  'LANCELOT : La dame du lac ??!! MELEAGANT : (Ironique et frappant dans les mains) Héhéhé! On va passer... Une bonne soirée! MAGNIFIQUE!',
  ...
  "LANCELOT : Si vous tenez tant à la mort d'Arthur, vous n'avez qu'à vous en occuper vous-même. MELEAGANT : Je n'ai aucun intérêt à la mort des gens. LANCELOT : Mais alors, à quoi ? Bon sang, à quoi ? MELEAGANT : A leur sabordage.",
  ...
  "-Qu'est-ce qui est petit et marron ? [Élias de Kelliwic'h : Un marron.] -Putain, il est fort ce con.",
  ...
  "Père Blaise : Non, je suis désolé, moi je peux pas faire une légende avec un vieux qui enroule sa bite autour d'un bâton. En plus je sais même pas comment ça se dit en latin. Arthur : Quoi ? Bite ? Père Blaise : Non, fakir.",
  ...
  "Bohort : [...] Et c'est joli. Père Blaise : Et c'est de la merde.",
  ...
  '[Arthur: Pour faire simple: on peut douter de tout sauf de la nécessité de se trouver du côté des opprimés] Ah bon! C\'est marrant parce que mon père, il a une phrase presque pareil: "On peut douter de tout sauf de la nécessité de se trouver du côté de celui qui a le pognon".',
